...
int app3 = D3; //appliance 1
int app4 = D4; //appliance 2`
//you can add more more appliances below.

String app1state = "off";// state of appliance1
String app2state = "off";// state of appliance2
String app3state = "off";// state of appliance1
String app4state = "off";// state of appliance2
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>DEazyLife Electronics wifi control</h1>");
            ...
            // If Appliance 4 is off, it displays the ON button
            if (app4state == "off") {
