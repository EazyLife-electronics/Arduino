...
void setup() {
  ...
  tft.drawCircle(CX, CY, 112, ILI9341_WHITE);
  ...
  num = 1;
  tft.setTextSize(1); yi = 0;
  for (float x = -60.0; x < 90.0; x += 10.0) {
    for (float y = 0.0; y <= 1.0; y += 0.1) {
      x1 = CX - (90 * cosd(x + y)); x2 = CX - (95 * cosd(x + y));
      y1 = CY - (90 * sind(x + y)); y2 = CY - (95 * sind(x + y));
  ...
  num = 0;
  tft.setTextSize(1); yi = 0;
  for (float x = 180.0; x > 90.0; x -= 15.0) {
    for (float y = 0.0; y <= 1.0; y += 0.1) {
      x1 = CX - (90 * cosd(x + y)); x2 = CX - (95 * cosd(x + y));
      y1 = CY - (90 * sind(x + y)); y2 = CY - (95 * sind(x + y));
      tft.drawLine(x1, y1, x2, y2, ILI9341_WHITE);
  ...
  num = 0;
  tft.setTextSize(1); yi = 0;
  for (float x = 180.0; x < 240.0; x += 15.0) {
    for (float y = 0.0; y <= 1.0; y += 0.1) {
      x1 = CX - (90 * cosd(x + y)); x2 = CX - (95 * cosd(x + y));
      y1 = CY - (90 * sind(x + y)); y2 = CY - (95 * sind(x + y));
      tft.drawLine(x1, y1, x2, y2, ILI9341_WHITE);
...
void loop() {
  SM = pulseIn(SPEEDOMETER, HIGH, 3000000);
